        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-xs uppercase tracking-wider text-surface-650 font-doto font-semibold">Email Identifier</Label>
              <Input
                id="email"
                type="email"
                ...
                required
                className="h-12 bg-white border-surface-200 focus:border-brand-900 focus:ring-brand-900 text-surface-900 font-roboto"
              />
            </div>

            {isRegisterMode && (
              <div className="space-y-2">
                <Label htmlFor="username" className="text-xs uppercase tracking-wider text-surface-650 font-doto font-semibold">Agent Callsign</Label>
                <Input
                  id="username"
                  type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-xs uppercase tracking-wider text-surface-650 font-doto font-semibold">Access Code</Label>
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-white border-surface-200 focus:border-brand-900 focus:ring-brand-900 text-surface-900 font-roboto"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                className="text-xs text-brand-900 hover:text-brand-800 hover:underline font-semibold uppercase tracking-wider font-doto"
              >
                Reset Code
              </a>
            </div>
            ...
            <Button 
              type="submit" 
              className="w-full h-12 text-base font-bold font-doto uppercase tracking-widest bg-brand-900 hover:bg-brand-800 text-white cursor-pointer" 
              size="lg" 
              disabled={isLoading}
            >
              {isLoading 
